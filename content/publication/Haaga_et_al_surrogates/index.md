...
summary = "We present two new methods for generating uni- and multivariate surrogate data derived from transfer operator approximation. We demonstrate how these surrogates can be used to produce more reliable statistics for the underlying dynamics, such as attractor dimension estimates."
